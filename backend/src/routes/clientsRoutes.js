  ...
  try {
    ...
    const result = await db.query(
      `UPDATE clients SET
        ...
        care_preferences=$25, mobility_assistance_needs=$26, referral_source_id=$27,
        care_type_id=COALESCE($28,care_type_id),
        is_private_pay=COALESCE($29,is_private_pay),
        private_pay_rate=COALESCE($30,private_pay_rate),
